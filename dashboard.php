...
<body class="bg-[#0f172a] text-slate-200 font-sans antialiased">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="lg:col-span-8 space-y-8">
                        ...
                        <div class="bg-slate-900/30 rounded-[2rem] border border-white/5 overflow-hidden">
                            ...
                            <div class="max-h-[165px] overflow-y-auto custom-scrollbar">
    ...
    <!-- Modal Foto -->
    <div id="photoModal" class="fixed inset-0 z-[100] hidden bg-[#0f172a]/95 backdrop-blur-md items-center justify-center p-6">
        <div class="relative bg-slate-900 rounded-[2.5rem] border border-white/10 max-w-2xl w-full overflow-hidden shadow-2xl scale-95 transition-transform duration-300">
            <div class="p-6 flex justify-between items-center border-b border-white/5">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-image text-indigo-500"></i>
                    <h3 class="font-black text-white text-sm uppercase tracking-widest">Capture Keamanan</h3>
                </div>
                <button onclick="closeModal()" class="h-10 w-10 flex items-center justify-center rounded-full bg-white/5 text-slate-400 hover:text-white transition-all">
                    <i class="fa-solid fa-xmark"></i>
                </button>
            </div>
            <div class="p-4 bg-black/50">
                <img id="imgPreview" src="" class="w-full h-auto rounded-[1.5rem] shadow-2xl shadow-indigo-500/10" />
            </div>
            <div class="p-6 text-center">
                <p class="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Smart Garage System - Secured Node</p>
            </div>
        </div>
    </div>
